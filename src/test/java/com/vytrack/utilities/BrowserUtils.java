...
public class BrowserUtils {
    ...
    public static void login (WebDriver driver, String user) {
        ...
        waitFor(1);
        driver.findElement(By.name("_username")).sendKeys(ConfigurationReader.get(user));
        WebElement passwordField = driver.findElement(By.name("_password"));
        passwordField.sendKeys(ConfigurationReader.get("password"));
